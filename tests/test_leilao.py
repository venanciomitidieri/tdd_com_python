...
class TestLeilao(TestCase):
    ...
    def test_deve_retornar_o_maior_e_o_menor_valor_de_um_lance_quando_adicionada_em_ordem_crescente(self):
    ...
    # se o leilao não tiver lances, deve permitir propor o lance
